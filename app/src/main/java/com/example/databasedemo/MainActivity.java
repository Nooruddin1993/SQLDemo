...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createTable() {
        String sql = "CREATE TABLE IF NOT EXISTS employees (" + "id INTEGER NOT NULL CONSTRAINT employee_pk PRIMARY KEY AUTOINCREMENT, " + "name VARCHAR(200) NOT NULL, " + "department VARCHAR(200) NOT NULL, " + "joiningdate DATETIME NOT NULL, " + "salary DOUBLE NOT NULL);";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tvViewEmployee:
                // Start another Activity to see Employees List
    ...
    private void addEmployee() {
        ...
        // using Calendar object to get Current Time
        Calendar calendar = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss");
        String joiningDate = sdf.format(calendar.getTime());

        if (name.isEmpty()) {
            editTextName.setError("Name filed is Mandatory");
